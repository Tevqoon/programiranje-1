...
def page_to_ads(page_content):
    ...
    vrne njih seznam"""
    pattern = re.compile(
        '<li class="EntityList-item EntityList-item--Regular(.*?)</article>', re.DOTALL) # Pika matcha vse, tudi newline
...
def get_dict_from_ad_block(block):
    ...
    # Lahko bi uporabili compile, lahkopa re.dOATALL uporabimo pri re.ime_metode
